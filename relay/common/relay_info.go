...
type ResponsesUsageInfo struct {
	...
	ImageGenerationCalls []ImageGenerationCallInfo
}

type ImageGenerationCallInfo struct {
...
type RelayInfo struct {
	...
	// and settlement uses the final selected group. Non-nil only for tiered_expr.
